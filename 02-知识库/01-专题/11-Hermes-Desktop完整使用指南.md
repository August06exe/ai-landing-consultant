...
|---|---|---|---|---|---|
| Weixin（个人微信，iLink） | ✅ | ✅ | ✅ | — | 专题01 大坑记录仍在：个人微信走 iLink Bot API（:83958） |
...
| 更新期 | 杀软隔离更新器脚本 → 更新假失败 | 修复安装+查隔离报告，恢复文件后重试；**官方明令不得关杀软** | llms-full.txt:834 ✅ | <!-- anchor-ok: 中英跨语言引用，2026-09-19 人工查证命中 -->

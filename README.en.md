...
**English** ｜ [简体中文（原文）](README.md) ｜ [日本語](README.ja.md)
...
| **You just want the knowledge base** | Read the [13 field guides](02-知识库/01-专题/) and [workflow recipes](02-知识库/05-配方库/01-六大通用模式配方.md) | Pull the latest official docs: `bash scripts/fetch-hermes-docs.sh` |

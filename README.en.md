...
**English** ｜ [简体中文（正宫）](README.md) ｜ [日本語](README.ja.md)
...
11 standard operating procedures · 8 consultant skills · 4 domain-compliance skill packs · 4 complete sample cases · 12 field guides
...
| **You just want the knowledge base** | Read the [12 field guides](02-知识库/01-专题/) and [workflow recipes](02-知识库/05-配方库/01-六大通用模式配方.md) | Pull the latest official docs: `bash scripts/fetch-hermes-docs.sh` |
...
| 🛠️ **8 skills** | grilling interview method · deep-search · web-crawler · **four domain advisors: finance / investment / data / legal**, each with compliance red lines | Built on [mattpocock/skills](https://github.com/mattpocock/skills) (MIT) |
| 📚 **Knowledge base ×12** | Channel selection (including the WeChat iLink pitfalls), Windows/Desktop deployment, model access, ops triage, secrets & privacy baseline, pain-point research, **a complete Desktop user guide**, **a 41-assertion instruction audit** | Every claim carries a source and date; instructions audited line-by-line against official docs |
...
### Four complete sample cases (fictional, and yes — template-ready)
...
flowchart TB
    subgraph L1["Access layer - client's daily chat apps"]
        W1["WeChat / WeCom"] ~~~ W2["Feishu / DingTalk"] ~~~ W3["Telegram / more"]
    end
    subgraph L2["Agent core - one file, one job"]
        SOUL["SOUL.md<br/>persona · organizes, never decides"] ~~~ AGENTS["AGENTS.md<br/>conventions · workflow index"]
    end
    subgraph L3["Workflow layer - six reusable patterns"]
        M1["Briefing"] ~~~ M2["Monitoring"] ~~~ M3["Filing"]
        M4["Reconciliation"] ~~~ M5["Draft & approve"] ~~~ M6["Ledger & calendar"]
        HB["Heartbeat<br/>daily check-in · silence = alert"]
    end
    subgraph L4["Guardrail layer - evolve within bounds"]
        G1["Evolution rules<br/>red lines"] ~~~ G2["Fail loudly<br/>never silent"] ~~~ G3["Cost awareness<br/>usage visible"]
    end
    L1 --> L2 --> L3 --> L4
```
...
02-知识库/      Knowledge base: 12 field guides | official docs (script-pulled) | reference skills | 4 cases | recipes
...
- [ ] Industry playbook marketplace · full i18n pipeline

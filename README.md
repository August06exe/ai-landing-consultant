...
11 道标准工序 · 8 个顾问技能（含 4 个领域合规包） · 6 个完整示例案例 · 14 份落地专题
...
| **只要知识库** | 直接读 [`02-知识库/01-专题/`](02-知识库/01-专题/) 十四份专题与[配方库](02-知识库/05-配方库/01-六大通用模式配方.md) | 拉最新官方文档：`bash scripts/fetch-hermes-docs.sh` |
...
| 📚 **落地知识库 ×14** | 渠道对照与选型（含微信 iLink 的坑）、Windows/Desktop 部署、模型接入、运维排查、**密钥与隐私基线**、落地痛点调研、专业领域盘点、**Desktop 完整使用指南**、**指令核对清单**、**门面对标解剖** | 每条结论带来源与日期，指令断言逐条核对过官方文档（38 行判定：11 ✗ 当场修源） |
...
02-知识库/      01-专题×14 | 02-官方文档(脚本拉取) | 03-参考技能 | 04-案例库(示例案例×6) | 05-配方库
